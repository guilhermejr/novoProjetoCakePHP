...
su vagrant -c "wget https://github.com/jquery/jquery/archive/3.2.1.zip -O /vagrant/jquery.zip"
...
cp -p /vagrant/jquery-3.2.1/dist/jquery.min.js /vagrant/app/webroot/js/
